...
const ChatScreen = () => {
    ...
    const { bookingId, buddyName } = route.params;
                    ...
                    <View style={styles.messageFooter}>
                        ...
                        {isMe && (
                            <Ionicons 
                                ...
                                size={14} 
                                color={item.isRead ? COLORS.mediumGray : "rgba(255,255,255,0.7)"} 
                                style={{ marginLeft: 4 }}
                            />
                        )}
                    </View>
        ...
        >
            ...
            <View style={[styles.header, { paddingTop: insets.top + 10 }]}>
                ...
                <View style={styles.headerTitleContainer}>
                    <Text style={styles.headerTitle}>{buddyName}</Text>
                </View>
                <TouchableOpacity 
                    onPress={() => navigation.navigate('VoiceCall', { bookingId, buddyName })} 
