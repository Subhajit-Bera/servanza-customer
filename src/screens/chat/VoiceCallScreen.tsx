...
const VoiceCallScreen = () => {
    ...
    const { bookingId, buddyName, isIncoming } = route.params;
            ...
            >
                ...
                <View style={styles.mainContent}>
                    <View style={styles.avatarContainer}>
                        <Text style={styles.avatarText}>{buddyName.charAt(0)}</Text>
                    </View>
                    ...
                    <View style={styles.controlRow}>
                        ...
                        >
                            <Ionicons 
                                ...
                                size={28} 
                                color={isMuted ? COLORS.charcoal : "white"} 
                            />
                        ...
                        >
                            <Ionicons 
                                ...
                                size={28} 
                                color={isSpeaker ? COLORS.charcoal : "white"} 
                            />
...
const styles = StyleSheet.create({
    ...
    endButton: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        transform: [{ rotate: '135deg' }], // Rotate call icon downwards
        elevation: 8,
        shadowColor: '#EF4444',
